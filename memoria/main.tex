...
\label{cap:metodologia-exp}
%==============================================================================
% TODO: ojo, aquí tu placeholder decía \label{cap:metodologia} — lo he
% renombrado a cap:metodologia-exp para no chocar con \cref{cap:metodologia}
% del capítulo 1, que apunta a un capítulo de metodología distinto (más
% centrado en arquitectura + CTC + entrenamiento). Vuelve a mirar el capítulo 1
% y decide el mapeo final de capítulos antes de tocar más etiquetas.

\section{Entorno y recursos computacionales}
\label{sec:entorno}
% Google Colab, GPU L4, ESPnet-EZ, presupuesto de cómputo por bloque.

\section{Preprocesado de señales}
\label{sec:preprocesado}
% Normalización, manejo de longitudes variables, verificación de integridad HDF5.

\section{Protocolo de entrenamiento}
\label{sec:protocolo}
% Hiperparámetros de la RECETA, splits, criterio de parada (el bug de
% early_stopping_criterion que arreglaste).

\section{Métricas de evaluación}
\label{sec:metricas}
% CER, PER, WER. Definición formal de cada una.
...
\section{Diseño experimental por bloques}
