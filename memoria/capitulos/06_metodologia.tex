...
\begin{description}
  ...
  \item[Búsqueda en haz.] Decodificación autorregresiva con el decodificador completo, con tamaño de haz 5. Es mucho más costosa por ensayo, por lo que se limita a 200 ensayos.
\end{description}

Ambos procedimientos evalúan \textbf{sobre los mismos ensayos}, seleccionados de forma equiespaciada a lo largo de la partición. Inicialmente la búsqueda en haz tomaba los primeros ensayos y la decodificación voraz una muestra repartida; con 45 sesiones, los primeros ensayos corresponden todos a los primeros días de registro, de modo que ambas cifras se estaban midiendo sobre subconjuntos distintos y no eran comparables entre sí.
