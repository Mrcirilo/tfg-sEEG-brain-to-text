...
Este bloque exige una precaución que lo distingue del resto. Las variantes lineal y convolucional unidimensional aplican un factor de submuestreo fijo de cuatro, mientras que la receta de referencia emplea la variante profunda con factor dos. Comparadas directamente, la arquitectura del adaptador quedaría \textbf{confundida con la resolución temporal}, que es exactamente el defecto experimental que este trabajo se propone evitar. La comparación debe ejecutarse, por tanto, igualando el factor de submuestreo en todas las variantes, o bien reportando explícitamente ambos ejes y absteniéndose de atribuir la diferencia a la arquitectura.
