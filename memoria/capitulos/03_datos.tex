...
\begin{table}[htbp]
  \centering
  \caption{Comparativa de los conjuntos de datos evaluados para este trabajo.}
  \label{tab:datasets-comparativa}
  \scriptsize
  \begin{tabular}{p{2.3cm} p{2.2cm} p{2.2cm} p{2.2cm} p{2.4cm}}
    \toprule
    \textbf{Característica} & \textbf{UGR-MINDVOICE} & \textbf{sEEG2Speech} & \textbf{SingleWord Dutch} & \textbf{Brain-to-Text '25} \\
    \midrule
    Tipo de señal      & EEG (64 can.)      & sEEG              & sEEG (1.103 can.) & Microelectrodos intracorticales (256) \\
    Participantes      & 15                 & 3                 & 10                & 1 \\
    Idioma             & Español            & Neerlandés        & Neerlandés        & Inglés \\
    Nivel de tarea     & Palabras y sílabas & Frases (5--7 pal.)& Palabras aisladas & Frases (habla continua) \\
    Tipo de habla      & \textit{Overt} y \textit{covert} & Solo \textit{overt} & Solo \textit{overt} & Intento vocalizado y silente \\
    Volumen            & 60 pal. + 30 pseudo + 95 sílabas & 100 frases & 100 palabras & 10.948 frases \\
    Duración           & 2,5--3 h/sesión    & 10--20 min/sujeto & $\sim$5 min/sujeto & 45 sesiones / 20 meses \\
    Frec.\ muestreo    & \SI{1000}{\hertz}  & 1024--\SI{2048}{\hertz} & \SI{1024}{\hertz} & Ventanas de \SI{20}{\milli\second} \\
    Salida objetivo    & Clasificación / texto & Audio & Espectrograma / audio & Texto \\
    Formato            & MNE/EDF            & Propio (OSF)      & BIDS / NWB        & HDF5 con particiones \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{enumerate}[label=\textbf{R\arabic*.}, leftmargin=*, itemsep=0.4em]
  ...
  \item \textbf{Escala de datos frente a escala de modelo.} Poco más de ocho mil frases de entrenamiento para un modelo de más de cien millones de parámetros sitúan el problema en un régimen de alto riesgo de sobreajuste, y hacen inviables las unidades de salida con vocabularios grandes: repartir ese número de frases entre decenas de miles de clases de subpalabra deja la mayoría de las clases con un puñado de ejemplos o ninguno.
